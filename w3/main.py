...
import constants
from global_utils import get_file_name, make_dir
import argparse
...
def main() -> List[Dict]:
    ...
    # Processes method (does not return result to main thread)
    # processes = []
    # for i in range(n_processes):
    #     p = multiprocessing.Process(target=run, args=(batches[i], n_processes))
    #     processes.append(p)
